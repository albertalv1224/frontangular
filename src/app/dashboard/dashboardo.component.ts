...
const ELEMENT_DATA: productsData[] = [
  ...
  },
  {
    ...
    uname: 'facrtura20.xml',
    position: 'CFDI',
    hourRate: new Date('2022-01-01'),
    classes: 'Error CFDI40222',
    priority: 'No Valida',
  },
  {
    id: 3,
...
@Component({
  ...
  templateUrl: './dashboardo.component.html',
  styleUrls: ['./dashboardo.component.css'],
  ...
  stats: stats[] = [
    {
      ...
      time: '09.30 am',
      color: 'primary',
      subtext: 'Error en el CFDI, Error "CFDI40222"',
    },
    {
      id: 2,
      time: '10.30 am',
      ...
      link: '#Requiere Validacion',
    },
    {
      id: 3,
      time: '12.30 pm',
      color: 'success',
      subtext: 'Validacion CFDI "factura1.xml"',
    },
    {
      id: 4,
      time: '12.30 pm',
      color: 'warning',
      title: 'Error al añadir subsidiaria',
      link: '#ML-3467',
    },
    {
      id: 5,
      time: '12.30 pm',
      color: 'error',
      title: 'Error en el CFDI, Error "CFDI40222"',
      link: '#ML-3467',
    },
    {
      id: 6,
